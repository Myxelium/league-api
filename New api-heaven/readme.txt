...
I edit har jag gjort ett mer användarvänligt interface för API'n där man skriver in exempelvis "jinx" så kommer informationen upp där med hjälp av bilder.
